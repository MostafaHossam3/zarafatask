...
class StatusBarManager {
  ...
  static setLikeBackgroundColor({required BuildContext context, Color? backgroundColor, bool reverseIconColor = false}) async {
    await FlutterStatusbarcolor.setStatusBarColor(backgroundColor ?? Theme.of(context).colorScheme.background);
